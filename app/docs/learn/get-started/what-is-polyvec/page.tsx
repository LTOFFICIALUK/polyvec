...
export default function WhatIsPolyVecPage() {
  return (
    <DocsPage
      breadcrumb="Get Started"
      title="What is PolyVec?"
      description="PolyVec is a professional trading terminal for Polymarket, the world's largest prediction market. It provides advanced tools for trading crypto price prediction events with real-time data, historical charts, and sophisticated order management."
      tableOfContents={[
    ...
    >
      <DocsParagraph>
        Unlike basic trading interfaces, PolyVec offers a terminal-style experience with live orderbook data, 
      ...
      <DocsSection id="understanding-prices" title="Understanding Prices">
        <DocsParagraph>
          Prices on PolyVec represent the market&apos;s belief in the probability of an outcome. A YES share 
      ...
      <DocsSection id="making-money" title="Making Money on Markets">
        <DocsParagraph>
          There are several strategies for profitable trading on PolyVec:
        </DocsParagraph>
        ...
        <DocsParagraph>
          ...
          PolyVec shows spread analysis to help identify these opportunities.
        </DocsParagraph>
      </DocsSection>
      ...
      <DocsSection id="key-features" title="Key Features">
        <DocsList items={[
          ...
          { title: 'Custodial Wallets', description: 'trade without Web3 wallets — we manage your wallet and transactions automatically' },
          { title: 'Fast Trading', description: 'no wallet confirmations needed — orders execute instantly' },
        ]} />
      </DocsSection>
    </DocsPage>
  )
